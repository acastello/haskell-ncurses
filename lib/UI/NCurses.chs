...
-- | Get the actual output to the terminal, this function isn't usually
-- needed outside of ncurses extensions like Menu
refreshWindow :: Window -> Curses ()
refreshWindow w = Curses $ checkRC "refreshWindow " =<< {# call wrefresh #} w

-- | As with @refreshWindow@, but with the default window
refresh :: Curses ()
refresh = Curses $ checkRC "refresh" =<< c_refresh
